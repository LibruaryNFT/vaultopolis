export const acceptTopShotOffer_child = `
...
// Parameters:
//   childAddress   : Address  – the HC child that owns the Top Shot moment
//   buyerAddress   : Address  – the buyer who created the offer
//   offerId        : UInt64   – ID of the offer to accept
//   momentIdToSell : UInt64   – ID of the Top Shot moment (in the child) to sell
...
transaction(childAddress: Address, buyerAddress: Address, offerId: UInt64, momentIdToSell: UInt64) {
    ...
    prepare(parent: auth(Storage, Capabilities) &Account) {
        ...
        // 2) Use HybridCustody to borrow withdraw capability from the child Top Shot collection
        ...
        ) ?? panic("Controller ID for child's Top Shot collection not found")
