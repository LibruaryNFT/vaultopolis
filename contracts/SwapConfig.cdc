...
access(all) contract SwapConfig {
    ...
    init() {
        self.PairPublicPath = /public/increment_swap_pair_new
        self.LpTokenCollectionStoragePath = /storage/increment_swap_lptoken_collection_new
        self.LpTokenCollectionPublicPath  = /public/increment_swap_lptoken_collection_new
