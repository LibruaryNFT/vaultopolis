...
# Send setup_vault transaction for TSHOTR
Log-Message "Sending setup_vault transaction for TSHOT..."
flow transactions send ./topshotexchange/transactions/setup_vault_tshotr.cdc
...
flow scripts execute ./topshotexchange/scripts/verify_vault_tshotr.cdc 0xf8d6e0586b0a20c7
Log-Message "verify_vault script executed for 0xf8d6e0586b0a20c7."
$summarySteps += "TSHOT vaults verified."

# Send setup_vault transaction for TSHOTR
Log-Message "Sending setup_vault transaction for TSHOT..."
flow transactions send ./topshotexchange/transactions/setup_vault_tshotr.cdc --signer=justin
Log-Message "setup_vault transaction sent."
$summarySteps += "TSHOT vault setup."

# Execute verify_vault script for both accounts
Log-Message "Executing verify_vault script for 0x179b6b1cb6755e31..."
flow scripts execute ./topshotexchange/scripts/verify_vault_tshotr.cdc 0x179b6b1cb6755e31
Log-Message "verify_vault script executed for 0x179b6b1cb6755e31."

# Send mint_TSHOTR transaction
#1-3 ultimate
#4-18 base
#19-33 legendary
#34-48 rare
...
flow transactions send ./topshotexchange/transactions/swap_nfts_for_tshotr.cdc [34] --signer=justin
...
Log-Message "Sending mint_TSHOT transaction..."
flow transactions send ./topshotexchange/transactions/swap_nfts_for_tshotr.cdc [1] --signer=justin
Log-Message "mint_TSHOT transaction sent."
$summarySteps += "TSHOT minted."

# Send mint_TSHOT transaction - Should fail because its common
Log-Message "Sending mint_TSHOT transaction..."
flow transactions send ./topshotexchange/transactions/swap_nfts_for_tshotr.cdc [4] --signer=justin
Log-Message "mint_TSHOT transaction sent."
$summarySteps += "TSHOT minted."

# Send mint_TSHOT transaction - Should fail because its legendary
Log-Message "Sending mint_TSHOT transaction..."
flow transactions send ./topshotexchange/transactions/swap_nfts_for_tshotr.cdc [19] --signer=justin
Log-Message "mint_TSHOT transaction sent."
$summarySteps += "TSHOT minted."

# Send mint_TSHOT transaction - Should fail because its fandom
Log-Message "Sending mint_TSHOT transaction..."
flow transactions send ./topshotexchange/transactions/swap_nfts_for_tshotr.cdc [49] --signer=justin
Log-Message "mint_TSHOT transaction sent."
$summarySteps += "TSHOT minted."
...
flow scripts execute ./topshotexchange/scripts/verify_balance_tshotr.cdc 0xf8d6e0586b0a20c7
...
flow scripts execute ./topshotexchange/scripts/verify_balance_tshotr.cdc 0x179b6b1cb6755e31
...
flow transactions send ./topshotexchange/transactions/swap_tshotr_for_nfts.cdc 1.0 --signer=justin
...
flow scripts execute ./topshot/scripts/get_collection_ids.cdc 0x179b6b1cb6755e31
flow scripts execute ./topshotexchange/scripts/verify_balance_tshot.cdc 0x179b6b1cb6755e31
