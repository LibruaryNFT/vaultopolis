...
flow transactions send ./topshotexchange/transactions/setup_vault_tshot.cdc
...
flow scripts execute ./topshotexchange/scripts/verify_vault_tshot.cdc 0xf8d6e0586b0a20c7
Log-Message "verify_vault script executed for 0xf8d6e0586b0a20c7."
$summarySteps += "TSHOT vaults verified."

# Send setup_vault transaction for TSHOT
Log-Message "Sending setup_vault transaction for TSHOT..."
flow transactions send ./topshotexchange/transactions/setup_vault_tshot.cdc --signer=justin
Log-Message "setup_vault transaction sent."
$summarySteps += "TSHOT vault setup."

# Execute verify_vault script for both accounts
Log-Message "Executing verify_vault script for 0x179b6b1cb6755e31..."
flow scripts execute ./topshotexchange/scripts/verify_vault_tshot.cdc 0x179b6b1cb6755e31
...
flow transactions send ./topshotexchange/transactions/swap_nfts_for_tshot.cdc [4] --signer=justin
...
Log-Message "Sending mint_TSHOT transaction..."
flow transactions send ./topshotexchange/transactions/swap_nfts_for_tshot.cdc [1] --signer=justin
Log-Message "mint_TSHOT transaction sent."
$summarySteps += "TSHOT minted."

# Send mint_TSHOT transaction - Should fail because its legendary
Log-Message "Sending mint_TSHOT transaction..."
flow transactions send ./topshotexchange/transactions/swap_nfts_for_tshot.cdc [19] --signer=justin
Log-Message "mint_TSHOT transaction sent."
$summarySteps += "TSHOT minted."

# Send mint_TSHOT transaction - Should fail because its legendary
Log-Message "Sending mint_TSHOT transaction..."
flow transactions send ./topshotexchange/transactions/swap_nfts_for_tshot.cdc [34] --signer=justin
Log-Message "mint_TSHOT transaction sent."
$summarySteps += "TSHOT minted."

# Send mint_TSHOT transaction - Should fail because its fandom
Log-Message "Sending mint_TSHOT transaction..."
flow transactions send ./topshotexchange/transactions/swap_nfts_for_tshot.cdc [49] --signer=justin
Log-Message "mint_TSHOT transaction sent."
$summarySteps += "TSHOT minted."
...
flow scripts execute ./topshotexchange/scripts/verify_balance_tshot.cdc 0xf8d6e0586b0a20c7
...
flow transactions send ./topshotexchange/transactions/swap_tshot_for_nfts.cdc 1.0 --signer=justin
