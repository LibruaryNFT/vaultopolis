...
flow transactions send ./tshot/transactions/setup_vault.cdc --network=testnet --signer=testnet-account
...
flow scripts execute ./tshot/scripts/verify_vault.cdc 0x332ffc0ae9bba9c1 --network=testnet
...
flow scripts execute ./tshot/scripts/verify_vault.cdc 0xa1d297b2610cba6a --network=testnet
...
flow transactions send ./tshot/transactions/exchange_NFT.cdc [1] --network=testnet
